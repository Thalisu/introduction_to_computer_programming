...
void print_winner(Card card_1, Card card_2) {
  ...
  print_card_winner_between_two_values(card_1.pib_per_capita,
                                       card_2.pib_per_capita);

  printf("Super Poder: ");
  print_card_winner_between_two_values(card_1.super_power_value,
                                       card_2.super_power_value);
}
